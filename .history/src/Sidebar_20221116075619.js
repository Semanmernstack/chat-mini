...
function Sidebar() {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-400  border-r-2 p-2 ">
        ...
        <div className=" flex items-center space-x-2 mb-5 font-serif">
            <img className="h-8 w-8 lg:h-12 lg:w-12 rounded-full"   src={user.photo} alt="img" /> 
            <h3>{user.displayName}</h3> 
            
        </div>
        <h1 onClick={signOut} className="text-center text-red-500 text-sm m-1 cursor-pointer" >Logout</h1>
